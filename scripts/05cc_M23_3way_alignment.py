...
cmd.color("red", "PL25_M23"); cmd.color("orange","CwlT_Cterm"); cmd.color("tv_blue","CwlP_M23")
...
cmd.color("red", "PL25_N"); cmd.color("orange","CwlT_GH25"); cmd.color("tv_blue","CwlP_SLT")
